...
if (isset($_POST['upload'])) {
    ...
    if(move_uploaded_file($tmp, $path)) {
        ...
        $update="UPDATE user SET gambar='$nama_baru' WHERE user_id = '".$_SESSION['id_user']."'";
...
?><div class="row">
                            ...
                            <div class="col-md-4"><?php $profil=$koneksi->query("SELECT * FROM user WHERE user_id = '".$_SESSION['id_user']."'");
