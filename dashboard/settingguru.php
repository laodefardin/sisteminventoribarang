...
<div class="content">
    <div class="container-fluid">
        ...
        $data            = $koneksi->query("SELECT password FROM anggota WHERE password='$password_lama'");
        if ($data->num_rows) {
        ...
        if ($password_baru == $konfirmasi_password) {
                ...
                $password_baru  = md5(sha1(md5($password_baru)));
                 ...
                 $update = $koneksi->query("UPDATE anggota SET password='$password_baru' WHERE id_anggota = '" . $_SESSION['id_anggota'] . "'");
                if ($update) {
