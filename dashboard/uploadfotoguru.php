...
if (isset($_POST['upload'])) {
    ...
    if(move_uploaded_file($tmp, $path)) {
        ...
        $update="UPDATE anggota SET gambar='$nama_baru' WHERE id_anggota = '".$_SESSION['id_anggota']."'";
        ...
        echo "<script type='text/javascript'>window.location = 'uploadfotoguru'</script>";
...
?><div class="row">
                            <div class="col-md-4">
                                <h3>Upload Foto Profil Ukuran 3x4 </h3>
                                <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    <input type="file" name="foto" id="foto" accept="image/jpeg"><br><button
                                        class="btn btn-primary btn-sm" name="upload" type="submit">Upload</button>
                            </div>
                            <div class="col-md-4"><?php $profil=$koneksi->query("SELECT * FROM anggota WHERE id_anggota = '".$_SESSION['id_anggota']."'");
